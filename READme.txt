...
This Streamlit dashboard parses, analyzes, and visualizes large volumes of unstructured research/trading system logs — demonstrating the exact skills required for a Python Analyst role in quantitative trading firms (e.g., Eqvilent).
...
Python-based Streamlit tool for analyzing quant research/trading logs. Parses JSONL logs, computes metrics, detects anomalies, and provides interactive dashboard with filters, visualizations, and report export.
